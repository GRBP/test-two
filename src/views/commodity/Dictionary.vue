        ...
        <div class="data">
            ...
            <div class="ledger-data">
                ...
                >
                    ...
                    <!-- <el-table-column prop="goodsLimit" label="商品限制(数量)" align="center" ></el-table-column> -->
                    <el-table-column prop="goodsName" label="商品名称" align="center" > </el-table-column>
                    <el-table-column prop="goodsPrice" label="商品单价" align="center" ></el-table-column>
                    <el-table-column prop="goodsUnit" label="商品单位" align="center" ></el-table-column>
                    <el-table-column prop="goodsTypeName" label="商品类别名称" align="center" ></el-table-column>
